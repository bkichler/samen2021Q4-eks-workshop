...
```
cd ~/environment/calico_resources
wget https://eksworkshop.com/samen/120_network-policies/calico/stars_policy_demo/create_resources.files/namespace.yaml
```
...
```
cd ~/environment/calico_resources
wget https://eksworkshop.com/samen/120_network-policies/calico/stars_policy_demo/create_resources.files/management-ui.yaml
wget https://eksworkshop.com/samen/120_network-policies/calico/stars_policy_demo/create_resources.files/backend.yaml
wget https://eksworkshop.com/samen/120_network-policies/calico/stars_policy_demo/create_resources.files/frontend.yaml
wget https://eksworkshop.com/samen/120_network-policies/calico/stars_policy_demo/create_resources.files/client.yaml
```
